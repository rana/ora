...
func (bnd *bndUint32Slice) bindOra(values *[]Uint32, position namedPos, stmt *Stmt, isAssocArray bool) (uint32, error) {
...
func (bnd *bndUint32Slice) bind(values *[]uint32, position namedPos, stmt *Stmt, isAssocArray bool) (iterations uint32, err error) {
	bnd.stmt = stmt
	V := *values
	L, C := len(V), cap(V)
