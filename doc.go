...
choice. Currently, the optional glog package and the optional log15 package have
built-in support.

To use the optional glog package:
...
See https://github.com/ranaian/ora/tree/master/samples/glg for sample code which
uses glog.

To use the optional log15 package:
...
See https://github.com/ranaian/ora/tree/master/samples/lg15 for sample code which
uses log15.
