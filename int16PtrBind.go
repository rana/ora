...
func (b *int16PtrBind) bind(value *int16, position int, ocistmt *C.OCIStmt) error {
	b.value = value
	r := C.OCIBindByPos2(
...
func (b *int16PtrBind) setPtr() error {
	if b.isNull > -1 {
		r := C.OCINumberToInt(
...
func (b *int16PtrBind) close() {
	defer func() {
		recover()
	}()
	b.ocibnd = nil
	b.value = nil
	b.env.int16PtrBindPool.Put(b)
}
