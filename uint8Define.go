...
func (d *uint8Define) define(position int, ocistmt *C.OCIStmt) error {
	r := C.OCIDefineByPos2(
...
func (d *uint8Define) value() (value interface{}, err error) {
	if d.isNull > -1 {
...
func (d *uint8Define) alloc() error {
	return nil
}

func (d *uint8Define) free() {

}

func (d *uint8Define) close() {
	defer func() {
		recover()
	}()
	d.ocidef = nil
	d.isNull = C.sb2(0)
	d.env.uint8DefinePool.Put(d)
}
