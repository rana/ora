...
func (d *uint32Define) define(position int, ocistmt *C.OCIStmt) error {
	r := C.OCIDefineByPos2(
...
func (d *uint32Define) value() (value interface{}, err error) {
	if d.isNull > -1 {
...
func (d *uint32Define) alloc() error {
	return nil
}

func (d *uint32Define) free() {

}

func (d *uint32Define) close() {
	defer func() {
		recover()
	}()
	d.ocidef = nil
	d.isNull = C.sb2(0)
	d.env.uint32DefinePool.Put(d)
}
