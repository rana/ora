...
func (b *uint32Bind) bind(value uint32, position int, ocistmt *C.OCIStmt) error {
...
func (b *uint32Bind) setPtr() error {
	return nil
}

func (b *uint32Bind) close() {
	defer func() {
		recover()
	}()
	b.ocibnd = nil
	b.env.uint32BindPool.Put(b)
}
