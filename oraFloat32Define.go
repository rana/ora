...
func (d *oraFloat32Define) define(position int, ocistmt *C.OCIStmt) error {
	r := C.OCIDefineByPos2(
...
func (d *oraFloat32Define) value() (value interface{}, err error) {
	float32Value := Float32{IsNull: d.isNull < 0}
...
func (d *oraFloat32Define) alloc() error {
	return nil
}

func (d *oraFloat32Define) free() {

}

func (d *oraFloat32Define) close() {
	defer func() {
		recover()
	}()
	d.ocidef = nil
	d.isNull = C.sb2(0)
	d.env.oraFloat32DefinePool.Put(d)
}
