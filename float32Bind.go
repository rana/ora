...
func (b *float32Bind) bind(value float32, position int, ocistmt *C.OCIStmt) error {
...
func (b *float32Bind) setPtr() error {
	return nil
}

func (b *float32Bind) close() {
	defer func() {
		recover()
	}()
	b.ocibnd = nil
	b.env.float32BindPool.Put(b)
}
