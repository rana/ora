...
func (b *oraIntervalDSSliceBind) bind(values []IntervalDS, position int, ocistmt *C.OCIStmt) error {
...
func (b *oraIntervalDSSliceBind) setPtr() error {
	return nil
}

func (b *oraIntervalDSSliceBind) close() {
	defer func() {
		recover()
	}()
	...
	b.ocibnd = nil
	b.ociIntervals = nil
	b.env.oraIntervalDSSliceBindPool.Put(b)
}

func (b *oraIntervalDSSliceBind) freeDescriptor(n int) {
	defer func() {
		recover()
	}()
	C.OCIDescriptorFree(
