...
func (d *int64Define) define(position int, ocistmt *C.OCIStmt) error {
	r := C.OCIDefineByPos2(
...
func (d *int64Define) value() (value interface{}, err error) {
	if d.isNull > -1 {
...
func (d *int64Define) alloc() error {
	return nil
}

func (d *int64Define) free() {

}

func (d *int64Define) close() {
	defer func() {
		recover()
	}()
	d.ocidef = nil
	d.isNull = C.sb2(0)
	d.env.int64DefinePool.Put(d)
}
