...
func (bnd *bndInt32Slice) bindOra(values *[]Int32, position namedPos, stmt *Stmt, isAssocArray bool) (uint32, error) {
...
func (bnd *bndInt32Slice) bind(values *[]int32, position namedPos, stmt *Stmt, isAssocArray bool) (iterations uint32, err error) {
	bnd.stmt = stmt
	V := *values
	L, C := len(V), cap(V)
