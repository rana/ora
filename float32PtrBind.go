...
func (b *float32PtrBind) bind(value *float32, position int, ocistmt *C.OCIStmt) error {
	b.value = value
	r := C.OCIBindByPos2(
...
func (b *float32PtrBind) setPtr() error {
	if b.isNull > -1 {
		r := C.OCINumberToReal(
...
func (b *float32PtrBind) close() {
	defer func() {
		recover()
	}()
	b.ocibnd = nil
	b.value = nil
	b.env.float32PtrBindPool.Put(b)
}
