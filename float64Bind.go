...
func (b *float64Bind) bind(value float64, position int, ocistmt *C.OCIStmt) error {
...
func (b *float64Bind) setPtr() error {
	return nil
}

func (b *float64Bind) close() {
	defer func() {
		recover()
	}()
	b.ocibnd = nil
	b.env.float64BindPool.Put(b)
}
