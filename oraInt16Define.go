...
func (d *oraInt16Define) define(position int, ocistmt *C.OCIStmt) error {
	r := C.OCIDefineByPos2(
...
func (d *oraInt16Define) value() (value interface{}, err error) {
	int16Value := Int16{IsNull: d.isNull < 0}
...
func (d *oraInt16Define) alloc() error {
	return nil
}

func (d *oraInt16Define) free() {

}

func (d *oraInt16Define) close() {
	defer func() {
		recover()
	}()
	d.ocidef = nil
	d.isNull = C.sb2(0)
	d.env.oraInt16DefinePool.Put(d)
}
