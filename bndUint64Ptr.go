...
func (bnd *bndUint64Ptr) bind(value *uint64, valueIsNull *bool, position namedPos, stmt *Stmt) error {
	...
	if value != nil {
		...
		bnd.stmt.logF(_drv.Cfg().Log.Stmt.Bind,
			"Uint64Ptr.bind(%v) value=%#v => number=%#v", position, value, bnd.ociNumber[0])
	}
