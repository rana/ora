...
func (bnd *bndInt16Slice) bindOra(values *[]Int16, position namedPos, stmt *Stmt, isAssocArray bool) (uint32, error) {
...
func (bnd *bndInt16Slice) bind(values *[]int16, position namedPos, stmt *Stmt, isAssocArray bool) (iterations uint32, err error) {
	bnd.stmt = stmt
	V := *values
	L, C := len(V), cap(V)
