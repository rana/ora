...
func (b *int64PtrBind) bind(value *int64, position int, ocistmt *C.OCIStmt) error {
	b.value = value
	r := C.OCIBindByPos2(
...
func (b *int64PtrBind) setPtr() error {
	if b.isNull > -1 {
		r := C.OCINumberToInt(
...
func (b *int64PtrBind) close() {
	defer func() {
		recover()
	}()
	b.ocibnd = nil
	b.value = nil
	b.env.int64PtrBindPool.Put(b)
}
