...
func (bnd *bndUint16Slice) bindOra(values *[]Uint16, position namedPos, stmt *Stmt, isAssocArray bool) (uint32, error) {
...
func (bnd *bndUint16Slice) bind(values *[]uint16, position namedPos, stmt *Stmt, isAssocArray bool) (iterations uint32, err error) {
	bnd.stmt = stmt
	V := *values
	L, C := len(V), cap(V)
