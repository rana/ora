...
func (b *uint64Bind) bind(value uint64, position int, ocistmt *C.OCIStmt) error {
...
func (b *uint64Bind) setPtr() error {
	return nil
}

func (b *uint64Bind) close() {
	defer func() {
		recover()
	}()
	b.ocibnd = nil
	b.env.uint64BindPool.Put(b)
}
