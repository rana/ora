...
func (b *uint16Bind) bind(value uint16, position int, ocistmt *C.OCIStmt) error {
...
func (b *uint16Bind) setPtr() error {
	return nil
}

func (b *uint16Bind) close() {
	defer func() {
		recover()
	}()
	b.ocibnd = nil
	b.env.uint16BindPool.Put(b)
}
