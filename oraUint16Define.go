...
func (d *oraUint16Define) define(position int, ocistmt *C.OCIStmt) error {
	r := C.OCIDefineByPos2(
...
func (d *oraUint16Define) value() (value interface{}, err error) {
	uint16Value := Uint16{IsNull: d.isNull < 0}
...
func (d *oraUint16Define) alloc() error {
	return nil
}

func (d *oraUint16Define) free() {

}

func (d *oraUint16Define) close() {
	defer func() {
		recover()
	}()
	d.ocidef = nil
	d.isNull = C.sb2(0)
	d.env.oraUint16DefinePool.Put(d)
}
